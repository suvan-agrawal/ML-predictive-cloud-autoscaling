...
# ──────────────────────────────────────────────
#  Custom CSS — works on both light and dark theme
# ──────────────────────────────────────────────
st.markdown("""
<style>
    /* ── Metric cards ── */
...
# ══════════════════════════════════════════════
#  TAB 6 — Live Monitor (uses st.fragment for independent refresh)
# ══════════════════════════════════════════════
with tab_monitor:
    ...
    st.markdown(
        ...
        "the next hour's load, and a scaling decision is made — all happening **live** below."
    )
    ...
    # ── This fragment auto-refreshes every 3s independently ──
    ...
    # ── Clear history button (outside fragment) ──
